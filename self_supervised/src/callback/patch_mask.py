...
class PatchCB(Callback):
    ...
    def __init__(self, patch_len, stride, features_domain):
        """
    ...
    def set_patch(self):
        ...
        """
        xb_patch, num_patch = create_patch(self.xb, self.patch_len, self.stride, self.features_domain)    # xb: [bs x seq_len x n_vars]
        self.learner.xb = xb_patch                              # xb_patch: [bs x num_patch x n_vars x patch_len]           


class PatchMaskCB(Callback):
    def __init__(self, patch_len, stride, mask_ratio, mask_schedule, overlap, features_domain,
    ...
    def patch_masking(self):
        ...
        xb_patch, num_patch = create_patch(self.xb, self.patch_len, self.stride, self.features_domain)    # xb_patch: [bs x num_patch x n_vars x patch_len]
...
def create_patch(xb, patch_len, stride, features_domain):
