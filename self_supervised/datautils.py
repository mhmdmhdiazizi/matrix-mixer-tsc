...
def get_dls(params):
    ...
    if params.dset == 'ettm1':
        ...
        root_path = 'data/datasets/classification/dataset/EMG/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
        ...
        root_path = 'data/datasets/classification/dataset/SleepEEG/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_cls,
                dataset_kwargs={
        ...
        root_path = 'data/datasets/classification/dataset/Epilepsy/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_cls,
                dataset_kwargs={
        ...
        root_path = 'data/datasets/classification/dataset/Gesture/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_cls,
                dataset_kwargs={
    ...
    elif params.dset == 'HAR':
        root_path = 'data/datasets/classification/dataset/HAR/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_cls,
                dataset_kwargs={
        ...
        root_path = 'data/datasets/classification/dataset/FD-B/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_cls,
                dataset_kwargs={
