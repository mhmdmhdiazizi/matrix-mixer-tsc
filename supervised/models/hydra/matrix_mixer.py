...
class RMSNorm(nn.Module):
    def __init__(self, dim: int, eps: float = 1e-6, elementwise_affine=False , **kwarg):
        super().__init__()
        self.dim = dim
        self.eps = eps
...
class MatrixMixer(nn.Module):
    def __init__(
        ...
        self.norm = RMSNorm(self.d_inner, eps=1e-5, elementwise_affine=False, **factory_kwargs)
    ...
    def forward(self, u, k = None, v = None, attn_mask=None, tau=None, delta=None):
        """
        u: (B, L, D)
